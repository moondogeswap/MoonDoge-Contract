...
contract MoonBar is BEP20('MoonBar Token', 'MBT') {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "MODO::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "MODO::delegateBySig: invalid nonce");
        require(now <= expiry, "MODO::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "MODO::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying MODOs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "MODO::_writeCheckpoint: block number exceeds 32 bits");
